...
// File lives at:  app/practice/writing/set/[id]/page.tsx
// Route example:  /practice/writing/set/1   (Package 1, tests 1–10)
//                 /practice/writing/set/11  (Package 2, tests 11–20)
...
export default function WritingSetPage() {
  const router = useRouter()
  const params = useParams()

  // startId is the first test number in this package (1, 11, 21 …)
      ...
      <div className="grid grid-cols-5 gap-3">
        {tests.map((testId) => {
          ...
          return (
            <div
              key={testId}
              onClick={() => router.push(`/practice/writing/${testId}`)}
              className={`
